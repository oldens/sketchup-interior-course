# SketchUp: Створення Простору для Життя
...
### Підсумкова презентація курсу
[SketchUp: Створення Простору для Життя (PDF)](./SketchUp-Stvorennya-Prostoru-dlya-Zhittya.pdf)

Підсумкова презентація для учнів — містить основні матеріали та підсумки курсу для учнів.
